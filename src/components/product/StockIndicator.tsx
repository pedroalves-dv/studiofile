...
export function StockIndicator({
  ...
  if (!availableForSale) {
    return (
      <div className="flex items-center gap-2 border border-error rounded-full px-2 py-1 w-fit">
  ...
  if (
    ...
    return (
      <div className="flex items-center gap-2 border border-accent rounded-full px-2 py-1 w-fit">
  ...
  return (
    <div className="flex items-center gap-2 border border-success rounded-full px-2 py-1 w-fit">
