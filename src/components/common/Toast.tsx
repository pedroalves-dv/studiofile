...
export function ToastItem({
  ...
  return (
    <div
      className={`animate-in slide-in-from-right border-l-4 ${borderColors[toast.type]} bg-ink text-canvas px-4 py-3 rounded-sm shadow-lg flex items-start gap-3 max-w-sm`}
    >
