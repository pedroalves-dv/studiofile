...
export function Button({
  ...
  const baseStyles =
    "relative inline-flex items-center justify-center text-sm transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent disabled:opacity-50 disabled:cursor-not-allowed";
