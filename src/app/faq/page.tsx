      ...
      <div className="">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-8 md:sticky md:top-24">
            ...
            <p className="text-base text-ink leading-relaxed px-6">
              We&apos;re a small studio — every enquiry is read and answered personally.
              Whether you&apos;re interested in a custom order, a press collaboration, or
              just want to learn more about our process, reach out.
            </p>
            ...
            <div className="space-y-4 border-t border-border pt-8">
              ...
              <div className="px-4">
                ...
                <p className="font-mono text-sm text-ink">Within 1–2 business days</p>
              </div>
            </div>
          </div>
