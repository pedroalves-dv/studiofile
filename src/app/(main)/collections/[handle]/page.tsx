    ...
    return (
      <div className="py-20 text-center">
        <p className="text-ink/60 mb-4">
          Unable to load collection at this time.
        </p>
    ...
    <PageWrapper>
      ...
      {collection.image && (
        <div className="relative w-full h-[400px] md:h-[500px] overflow-hidden bg-lighter">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent flex flex-col justify-end p-6 md:p-12">
            <h1 className="text-[clamp(2rem, 8vw, 4rem)] leading-tight text-canvas mb-4">
              {collection.title}
            </h1>
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto">
          {!collection.image && (
            <>
              <h1 className="text-[clamp(2.5rem, 8vw, 5rem)] leading-tight mb-4 text-ink">
                {collection.title}
              </h1>
              {collection.description && (
